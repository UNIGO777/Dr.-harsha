export function createPnsAssessmentClaudeHandler(getContext) {
  return async (req, res) => {
    try {
      ...
      const patient = {
        ...
        sex: typeof body.sex === "string" ? body.sex : "",
      ...
      const ai = await generatePnsAssessmentWithAi({
        openai: null,
        provider,
        patient,
        extractedText,
      ...
      res.json({ patient, pns: ai?.pns ?? ai });
    } catch (err) {
